...
// ════════════════════════════════════════════════════════════════
//  OWNER SMS BROADCAST — uses YOUR AT key, owner-funded (NO wallet
//  deduction). For system-wide updates / announcements to schools.
// ════════════════════════════════════════════════════════════════

/**
 * POST /api/sms/owner-broadcast
 * Body: { recipients: [{to, message, schoolId?, schoolName?}], requestId?, label? }
 *
 * No wallet check, no wallet deduction — owner's AT account/credit pays.
 * Use for announcements, system updates, maintenance notices, etc.
 * Every send is logged to ownerBroadcasts/{id}/recipients for audit.
 */
